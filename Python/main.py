...
# api key - ChatFight
openai.api_key = "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"



# (Debugging Mode) ./ https://melonicedlatte.com/2023/01/01/193400.html
options = Options()
options.add_experimental_option("debuggerAddress", "127.0.0.1:9222")
# chromedriver path
driver = webdriver.Chrome("/Users/USER/Desktop/Python/chromedriver", options=options)
